package com.example.a501_10.mytest1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] xml_list = getResources().getStringArray(R.array.musicList);
    ...
    private ArrayList<String> findFileByExt(String ext) {
        ...
        if (state.equals(Environment.MEDIA_MOUNTED)) {
            ...
            for (int i = 0; i < jpg_list.length; i++) {
                ...
                textView_title.setText("Play the Music");
            }
            return temp_array;
        } else {
